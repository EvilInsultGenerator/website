...
<head>
    ...
    <script src="https://use.fontawesome.com/YOURFONTAWESOMELINKHERE.js" async></script>
    ...
    <script>
        (function Generate () {
            ...
            $('#lang_select').on('change', function () {
                ...
                $.cookie('lang', lang);
                window.location.assign('http://evilinsult.com/index.php?lang=' + lang); // redirect
        ...
        <div class="pure-g">
            ...
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
                <h3 class="content-subhead">
                    ...
                    <p><a href="https://windows.com/" target="_blank"><?php echo $lang['WINDOWS']; ?></a></p>
                </h3>
            </div>
